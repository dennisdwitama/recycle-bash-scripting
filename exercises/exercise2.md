...
1. List all the contents of your `home` directory and save the output in a file called `homeList`. List the contents of your `tradingSystem` directory and append to the `homeList` file.
...
3. List the contents of your home directory and then count the number of lines in this output.
	...
	- Identify the command to count the number of lines
	- Combine these commands with a pipe
...
8. Display the records for brokers 7-9 of `brokers.dat`